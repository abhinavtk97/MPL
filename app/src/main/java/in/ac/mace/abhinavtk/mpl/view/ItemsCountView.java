package in.ac.mace.abhinavtk.mpl.view;
...
import in.ac.mace.abhinavtk.mpl.ExampleDataset;
import in.ac.mace.abhinavtk.mpl.R;
...
public class ItemsCountView extends LinearLayout {
    ...
    private void init(Context context) {
        data =  new ExampleDataset().getDataset();
    ...
    public void update(int newPosition, int oldPosition, int totalElements) {
        CardData data1 = (CardData) data.get(newPosition);
        int g1 = data1.getGoal1();
        int g2 = data1.getGoal2();
