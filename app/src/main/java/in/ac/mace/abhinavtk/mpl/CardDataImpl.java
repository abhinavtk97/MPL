...
public class CardDataImpl implements ECCardData<String> {
    ...
    public static List<ECCardData> generateExampleData() {
        ...
        list.add(new CardDataImpl("Card 1", R.drawable.footb2, R.drawable.attractions_head, createItemsList("Card 1")));
        list.add(new CardDataImpl("Card 2", R.drawable.footb1, R.drawable.footb1, createItemsList("Card 2")));
